...
export declare class AdjustConfig {
    ...
    private isSendingInBackgroundEnabled;
    private isDeferredDeeplinkOpeningEnabled;
    private isCostDataInAttributionEnabled;
    private isCoppaComplianceEnabled;
    private isDeviceIdsReadingOnceEnabled;
    private eventDeduplicationIdsMaxSize;
    private urlStrategyDomains;
    private useSubdomains;
    private isDataResidency;
    private isFirstSessionDelayEnabled;
    private storeInfo;
    ...
    private processName;
    private isPreinstallTrackingEnabled;
    private preinstallFilePath;
    private isPlayStoreKidsComplianceEnabled;
    private fbAppId;
    private isAdServicesEnabled;
    private isIdfaReadingEnabled;
    private isIdfvReadingEnabled;
    private isSkanAttributionEnabled;
    private isLinkMeEnabled;
    private attConsentWaitingInterval;
    private isAppTrackingTransparencyUsageEnabled;
    private skanUpdatedCallback;
...
export declare class AdjustThirdPartySharing {
    ...
    private partnerSharingSettings;
...
export declare class AdjustAppStorePurchase {
    private productId;
    private transactionId;
    constructor(productId: string, transactionId: string);
}
export declare class AdjustPlayStorePurchase {
    private productId;
    private purchaseToken;
    constructor(productId: string, purchaseToken: string);
}
export declare class AdjustDeeplink {
    private deeplink;
    private referrer;
    constructor(deeplink: string);
    setReferrer(referrer: string): void;
}
export declare class AdjustStoreInfo {
    private storeName;
    private storeAppId;
